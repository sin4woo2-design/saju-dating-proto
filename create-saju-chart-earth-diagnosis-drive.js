...
const DOC_TITLE = "[Saju] chart earth bias diagnosis v1";
const SHEET_TITLE = "[Saju] earth bias diagnosis matrix v1";
const REPORT_PATH = "daily-work/saju-chart-earth-bias-diagnosis-v1.md";
const CSV_PATH = "daily-work/saju-chart-earth-bias-diagnosis-v1.csv";
