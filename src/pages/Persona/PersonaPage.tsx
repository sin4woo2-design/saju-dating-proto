...
const fallbackNarrative: PersonaNarrativeSnapshot = {
  ...
  personaSubtitle: "상대 반응을 먼저 읽고 호흡을 맞출수록 매력이 자연스럽게 드러나는 타입이에요.",
  personaTraits: {
    relationTempo: "빠르게 끌어당기기보다 대화 온도를 맞추며 가까워질 때 훨씬 편안해져요.",
  ...
  appealPoint: "대화 온도를 맞출 때 매력이 가장 자연스럽게 살아나요.",
