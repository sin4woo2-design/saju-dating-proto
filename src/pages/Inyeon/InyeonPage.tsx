...
export default function InyeonPage() {
  return (
    <PageLayout title="인연" subtitle="본격 매칭 전, 궁합·인연 중심 콘텐츠를 먼저 즐겨보세요.">
      <section className="heroCard">
        <h3>오늘의 인연 포인트</h3>
        <p className="statusHint">대화가 편한 사람과의 연결이 강하게 들어오는 흐름이에요.</p>
      </section>
      ...
      <section className="homeHubGrid">
        ...
        <article className="hubCard">
          ...
          <p>인연 카드 큐레이션, 상황별 추천 대화 템플릿은 다음 버전에서 열려요.</p>
