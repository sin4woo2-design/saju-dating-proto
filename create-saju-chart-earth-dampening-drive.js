...
const DOC_TITLE = "[Saju] earth dampening sweep v1";
const SHEET_TITLE = "[Saju] earth dampening sweep matrix v1";
const REPORT_PATH = "daily-work/saju-chart-earth-dampening-sweep-v1.md";
const CSV_PATH = "daily-work/saju-chart-earth-dampening-sweep-v1.csv";
